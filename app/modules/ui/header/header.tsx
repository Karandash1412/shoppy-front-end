...
import ShoppingBascetIcon from '@mui/icons-material/ShoppingBasket';
        ...
        <AppBar position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    <ShoppingBascetIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
                    <Typography
                        variant="h6"
                        noWrap
                        component={Link}
                    ...
                    <ShoppingBascetIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
                    <Typography
                        variant="h5"
                        noWrap
                        component="a"
